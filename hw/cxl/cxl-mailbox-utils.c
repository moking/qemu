                                             ...
                                             CXLCCI *cci)
{
    ...
    stl_le_p(&extra_out->num_extents_supported, 0);
    stl_le_p(&extra_out->num_extents_available, 0);
    stl_le_p(&extra_out->num_tags_supported, 0);
    stl_le_p(&extra_out->num_tags_available, 0);
#endif
